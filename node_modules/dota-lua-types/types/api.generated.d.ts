...
declare interface CDOTA_BaseNPC extends CBaseFlex {
     ...
     */
    Kill(ability: CDOTABaseAbility, attacker: CDOTA_BaseNPC): void;
    MakeIllusion(): void;
     ...
     */
    ModifyHealth(desiredHealthValue: number, ability: CDOTABaseAbility, lethal: boolean, additionalFlags: number): void;
    /**
...
declare interface CDOTA_BaseNPC_Hero extends CDOTA_BaseNPC {
     ...
     */
    GetTogglableWearable(slotType: number): CBaseEntity;
     ...
     * Value is stored in PlayerResource.
     */
    IncrementAssists(killerId: number): void;
    /**
     * Value is stored in PlayerResource.
     */
    IncrementDeaths(killerId: number): void;
    /**
     * Value is stored in PlayerResource.
     */
     ...
     */
    IncrementKills(victimId: number): void;
    /**
     * Value is stored in PlayerResource.
     */
     ...
     */
    ModifyGold(goldChange: number, reliable: boolean, reason: number): number;
    /**
     * Adds passed value to base attribute value, then calls CalculateStatBonus.
     */
...
declare interface CDOTA_PlayerResource extends CBaseEntity {
    ...
    GetDamageDoneToHero(playerId: PlayerID, victimId: number): number;
     ...
     */
    SetCameraTarget(playerId: PlayerID, target: CDOTA_BaseNPC): void;
    ...
    WhoSelectedHero(heroFilename: string): PlayerID;
    __kind__: 'instance';
}
...
declare interface Convars {
    ...
    RegisterCommand(
        name: string,
        callback: (this: void, name: string, ...args: string[]) => void,
        helpString: string,
        flags: ConVarFlags,
    ): void;
    /**
...
declare interface CScriptHTTPRequest {
     ...
     * @both
     */
    Send(callback: (this: void, response: CScriptHTTPResponse) => void): boolean;
    /**
...
declare interface ProjectileManager {
     ...
     */
    CreateTrackingProjectile(options: CreateTrackingProjectileOptions): void;
    /**
...
declare const QAngle: DotaConstructor<QAngle> &
    ((this: void, x: number | undefined, y: number | undefined, z: number | undefined) => QAngle);
...
declare const Vector: DotaConstructor<Vector> & ((this: void, x?: number, y?: number, z?: number) => Vector);
 ...
 * @both
 */
declare function AngleDiff(this: void, arg1: number, arg2: number): number;
 ...
 * @both
 */
declare function AppendToLogFile(this: void, arg1: string, arg2: string): void;

/**
 * Damage an npc.
 */
declare function ApplyDamage(this: void, options: ApplyDamageOptions): number;
 ...
 * @both
 */
declare function AxisAngleToQuaternion(this: void, arg1: Vector, arg2: number): Quaternion;
 ...
 * @both
 */
declare function CalcClosestPointOnEntityOBB(this: void, arg1: object, arg2: Vector): Vector;
 ...
 * @both
 */
declare function CalcDistanceBetweenEntityOBB(this: void, arg1: object, arg2: object): number;

/** @both */
declare function CalcDistanceToLineSegment2D(this: void, arg1: Vector, arg2: Vector, arg3: Vector): number;
 ...
 * @both
 */
declare function CancelEntityIOEvents(this: void, arg1: number): void;

declare function ClearTeamCustomHealthbarColor(this: void, team: DOTATeam_t): void;
 ...
 * @both
 */
declare function CreateEffect(this: void, arg1: object): boolean;

/**
 * Creates a DOTA hero by its dota_npc_units.txt name and sets it as the given
 * player's controlled hero.
 */
declare function CreateHeroForPlayer(this: void, heroName: string, player: CDOTAPlayer): CDOTA_BaseNPC_Hero;
 ...
 * @both
 */
declare function CreateHTTPRequest(this: void, method: string, url: string): CScriptHTTPRequest;
 ...
 * @both
 */
declare function CreateHTTPRequestScriptVM(this: void, method: string, url: string): CScriptHTTPRequest;
 ...
 * a space).
 */
declare function CreateItemOnPositionForLaunch(
    this: void,
    location: Vector,
 ...
 */
declare function CreateItemOnPositionSync(
    this: void,
    location: Vector,
    item: CDOTA_Item | undefined,
): CDOTA_Item_Physical;
 ...
 */
declare function CreateRune(this: void, location: Vector, runeType: DOTA_RUNES): CBaseAnimating;

/**
 * Create a scene entity to play the specified scene.
 */
declare function CreateSceneEntity(this: void, arg1: string): CSceneEntity;

/**
 * Create a temporary tree, uses a default tree model.
 */
declare function CreateTempTree(this: void, location: Vector, duration: number): CBaseAnimating;

/**
 * Create a temporary tree, specifying the tree model name.
 */
declare function CreateTempTreeWithModel(
    this: void,
    location: Vector,
    duration: number,
    modelName: string,
 ...
 */
declare function CreateTrigger(this: void, arg1: Vector, arg2: Vector, arg3: Vector): CBaseTrigger;

/**
 * Creates and returns an AABB trigger thats bigger than the radius provided.
 */
declare function CreateTriggerRadiusApproximate(this: void, vecOrigin: Vector, radius: number): CBaseTrigger;
...
declare function CreateUnitByNameAsync(
    ...
    team: DOTATeam_t,
    callback: (this: void, unit: CDOTA_BaseNPC) => void,
): number;
 ...
 */
declare function CreateUnitFromTable(this: void, arg1: object, arg2: Vector): object;
 ...
 * @both
 */
declare function CrossVectors(this: void, arg1: Vector, arg2: Vector): Vector;
 ...
 * @both
 */
declare function cvar_getf(this: void, arg1: string): number;
 ...
 * @both
 */
declare function cvar_setf(this: void, arg1: string, arg2: number): boolean;
 ...
 * @both
 */
declare function DebugBreak(this: void): void;
 ...
 * @both
 */
declare function DebugDrawClear(this: void): void;
 ...
 * @both
 */
declare function DebugDrawLine_vCol(
    this: void,
    arg1: Vector,
    arg2: Vector,
    arg3: Vector,
 ...
 * @both
 */
declare function DebugDrawText(this: void, origin: Vector, text: string, viewCheck: boolean, duration: number): void;
 ...
 */
declare function DestroyDamageInfo(this: void, damageInfo: CTakeDamageInfo): void;
 ...
 * @both
 */
declare function DoIncludeScript(this: void, arg1: string, arg2: object): boolean;
 ...
 * @both
 */
declare function DoScriptAssert(this: void, arg1: boolean, arg2: string): void;

declare function DotProduct(this: void, arg1: Vector, arg2: Vector): number;
 ...
 * @both
 */
declare function DoUniqueString(this: void, seed: string): string;
 ...
 */
declare function EmitAnnouncerSound(this: void, soundName: string): void;

/**
 * Emit an announcer sound for a player.
 */
declare function EmitAnnouncerSoundForPlayer(this: void, soundName: string, playerId: PlayerID): void;

/**
 * Emit an announcer sound for a team.
 */
declare function EmitAnnouncerSoundForTeam(this: void, soundName: string, team: DOTATeam_t): void;

/**
 * Emit an announcer sound for a team at a specific location.
 */
declare function EmitAnnouncerSoundForTeamOnLocation(
    this: void,
    soundName: string,
    team: DOTATeam_t,
    location: Vector,
 ...
 */
declare function EmitGlobalSound(this: void, soundName: string): void;
 ...
 * @both
 */
declare function EmitSoundOn(this: void, soundName: string, entity: CBaseEntity): void;
 ...
 * @both
 */
declare function EmitSoundOnClient(this: void, soundName: string, arg2: object): void;

/**
 * Emit a sound on a location from a unit, only for players allied with that unit.
 */
declare function EmitSoundOnLocationForAllies(
    this: void,
    location: Vector,
    soundName: string,
    caster: CBaseEntity,
 ...
 * @both
 */
declare function EntIndexToHScript(this: void, entityIndex: EntityIndex): CBaseEntity | undefined;

/**
 * Issue an order from a script table.
 */
declare function ExecuteOrderFromTable(this: void, order: object): void;
 ...
 * @both
 */
declare function ExponentialDecay(this: void, arg1: number, arg2: number, arg3: number): number;

/**
 * Finds a clear random position around a given target unit, using the target
 * unit's padded collision radius.
 */
declare function FindClearRandomPositionAroundUnit(this: void, arg1: object, arg2: object, arg3: number): boolean;

/**
 * Place a unit somewhere not already occupied.
 */
declare function FindClearSpaceForUnit(this: void, unit: CDOTA_BaseNPC, location: Vector, arg3: boolean): boolean;

/**
 * Find a spawn point for the given team.
 */
declare function FindSpawnEntityForTeam(this: void, team: DOTATeam_t): CBaseEntity | undefined;
 ...
 * @both
 */
declare function FireEntityIOInputNameOnly(this: void, arg1: number, arg2: string): void;
 ...
 * @both
 */
declare function FireEntityIOInputString(this: void, arg1: number, arg2: string, arg3: string): void;
 ...
 * @both
 */
declare function FireEntityIOInputVec(this: void, arg1: number, arg2: string, arg3: Vector): void;
 ...
 *             instead.
 */
declare function GetDedicatedServerKey(this: void, version: string): string;

declare function GetDedicatedServerKeyV2(this: void, version: string): string;

/**
 * Get the enity index for a tree id specified as the entindex_target of a
 * DOTA_UNIT_ORDER_CAST_TARGET_TREE.
 */
declare function GetEntityIndexForTreeId(this: void, treeId: number): EntityIndex;
 ...
 * @both
 */
declare function GetFrameCount(this: void): number;

declare function GetGroundHeight(this: void, location: Vector, unitHull: CDOTA_BaseNPC | undefined): number;

/**
 * Returns the supplied position moved to the ground. Second parameter is an NPC
 * for measuring movement collision hull offset.
 */
declare function GetGroundPosition(this: void, location: Vector, unitHull: CDOTA_BaseNPC | undefined): Vector;

/**
 * Get the cost of an item by name.
 */
declare function GetItemCost(this: void, arg1: string): number;

declare function GetItemDefOwnedCount(this: void, arg1: number, arg2: number): number;

declare function GetItemDefQuantity(this: void, arg1: number, arg2: number): number;
 ...
 * @both
 */
declare function GetListenServerHost(this: void): CDOTAPlayer;

declare function GetLobbyEventGameDetails(this: void): object;
 ...
 * @client
 */
declare function GetLocalPlayerID(this: void): number;
 ...
 * @client
 */
declare function GetLocalPlayerTeam(this: void): number;
 ...
 * @both
 */
declare function GetMaxOutputDelay(this: void, arg1: number, arg2: string): number;
 ...
 * @both
 */
declare function GetPhysAngularVelocity(this: void, arg1: object): Vector;
 ...
 * @both
 */
declare function GetPhysVelocity(this: void, arg1: object): Vector;

/**
 * Get the current real world date.
 */
declare function GetSystemDate(this: void): string;

/**
 * Get the current real world time.
 */
declare function GetSystemTime(this: void): string;
...
declare function GetTeamHeroKills(this: void, team: DOTATeam_t): number;

declare function GetTeamName(this: void, team: DOTATeam_t): string;

/**
 * Given and entity index of a tree, get the tree id for use for use with with
 * unit orders.
 */
declare function GetTreeIdForEntityIndex(this: void, entityIndex: EntityIndex): number;

/**
 * Gets the world's maximum X position.
 */
declare function GetWorldMaxX(this: void): number;

/**
 * Gets the world's maximum Y position.
 */
declare function GetWorldMaxY(this: void): number;

/**
 * Gets the world's minimum X position.
 */
declare function GetWorldMinX(this: void): number;

/**
 * Gets the world's minimum Y position.
 */
declare function GetWorldMinY(this: void): number;

/**
 * Get amount of XP required to reach the next level.
 */
declare function GetXPNeededToReachNextLevel(this: void, level: number): number;
 ...
 * @both
 */
declare function InitLogFile(this: void, arg1: string, arg2: string): void;
 ...
 * @both
 */
declare function IsClient(this: void): boolean;
 ...
 * @both
 */
declare function IsDedicatedServer(this: void): boolean;
 ...
 * @both
 */
declare function IsInToolsMode(this: void): boolean;

/**
 * Ask fog of war if a location is visible to a certain team.
 */
declare function IsLocationVisible(this: void, team: DOTATeam_t, location: Vector): boolean;
 ...
 * @both
 */
declare function IsMarkedForDeletion(this: void, entity: CBaseEntity): boolean;
 ...
 * @both
 */
declare function IsServer(this: void): boolean;
 ...
 * @both
 */
declare function IsValidEntity(this: void, entity: object | undefined): entity is CBaseEntity;
 ...
 * @both
 */
declare function LerpVectors(this: void, arg1: Vector, arg2: Vector, arg3: number): Vector;

/**
 * Set the limit on the pathfinding search space.
 */
declare function LimitPathingSearchDepth(this: void, arg1: number): void;
 ...
 * @both
 */
declare function LinkLuaModifier(
    this: void,
    className: string,
    filePath: string,
    luaModifierType: LuaModifierType,
): void;
 ...
 * @both
 */
declare function LoadKeyValues(this: void, filePath: string): object;
 ...
 * @both
 */
declare function LoadKeyValuesFromString(this: void, kvString: string): object;
 ...
 * @both
 */
declare function LocalTime(this: void): LocalTime;
 ...
 * @both
 */
declare function MakeStringToken(this: void, arg1: string): number;
 ...
 * @both
 */
declare function Msg(this: void, message: string): void;

/**
 * Pause or unpause the game.
 */
declare function PauseGame(this: void, paused: boolean): void;
 ...
 * @both
 */
declare function PlayerInstanceFromIndex(this: void, entityIndex: EntityIndex): CDOTAPlayer | undefined;
 ...
 * @both
 */
declare function PrecacheEntityFromTable(this: void, arg1: string, arg2: object, context: CScriptPrecacheContext): void;
 ...
 * @both
 */
declare function PrecacheEntityListFromTable(this: void, arg1: object, context: CScriptPrecacheContext): void;

/**
 * Asynchronously precaches a DOTA item by its dota_npc_items.txt name, provides a
 * callback when it's finished.
 */
declare function PrecacheItemByNameAsync(
    this: void,
    itemName: string,
    callback: (this: void, precacheId: number) => void,
): void;

/**
 * Precaches a DOTA item by its dota_npc_items.txt name.
 */
declare function PrecacheItemByNameSync(this: void, itemName: string, context: CScriptPrecacheContext): void;

/**
 * Manually precache a single model.
 */
declare function PrecacheModel(this: void, modelName: string, context: CScriptPrecacheContext): void;

/**
 * Manually precache a single resource.
 */
declare function PrecacheResource(this: void, arg1: string, arg2: string, context: CScriptPrecacheContext): void;
 ...
 */
declare function PrecacheUnitFromTableAsync(
    this: void,
    arg1: object,
    callback: (this: void, precacheId: number) => void,
): void;
 ...
 * Precaches a DOTA unit from a table of entity key values.
 */
declare function PrecacheUnitFromTableSync(this: void, arg1: object, context: CScriptPrecacheContext): void;
 ...
 * @both
 */
declare function PrintLinkedConsoleMessage(this: void, message: string, tooltip: string): void;
 ...
 * @both
 */
declare function RandomFloat(this: void, min: number, max: number): number;
 ...
 * @both
 */
declare function RandomInt(this: void, min: number, max: number): number;

/**
 * Get a random 2D vector of the given length.
 */
declare function RandomVector(this: void, length: number): Vector;

/**
 * Register a custom animation script to run when a model loads.
 */
declare function RegisterCustomAnimationScriptForModel(this: void, arg1: string, arg2: string): void;
 ...
 * @both
 */
declare function RegisterSpawnGroupFilterProxy(this: void, arg1: string): void;
 ...
 * @both
 */
declare function ReloadMOTD(this: void): void;
 ...
 * @both
 */
declare function RemoveSpawnGroupFilterProxy(this: void, arg1: string): void;

/**
 * Check and fix units that have been assigned a position inside collision radius
 * of other NPCs.
 */
declare function ResolveNPCPositions(this: void, location: Vector, radius: number): void;
 ...
 * @both
 */
declare function RotateOrientation(this: void, arg1: QAngle, arg2: QAngle): QAngle;
 ...
 * @both
 */
declare function RotatePosition(this: void, arg1: Vector, arg2: QAngle, arg3: Vector): Vector;
 ...
 * @both
 */
declare function RotateQuaternionByAxisAngle(this: void, arg1: Quaternion, arg2: Vector, arg3: number): Quaternion;
 ...
 * @both
 */
declare function RotationDelta(this: void, arg1: QAngle, arg2: QAngle): QAngle;
 ...
 * @both
 */
declare function RotationDeltaAsAngularVelocity(this: void, arg1: QAngle, arg2: QAngle): Vector;
 ...
 * @both
 */
declare function rr_AddDecisionRule(this: void, arg1: object): boolean;
 ...
 * @both
 */
declare function rr_CommitAIResponse(this: void, entity: object, airesponse: object): boolean;
 ...
 * @both
 */
declare function rr_GetResponseTargets(this: void): object;
 ...
 * @both
 */
declare function rr_QueryBestResponse(this: void, arg1: object, arg2: object, arg3: object): boolean;

/**
 * Have Entity say string, and teamOnly or not.
 */
declare function Say(this: void, entity: CBaseEntity, message: string, teamOnly: boolean): void;
...
/**
 * SendToPlayer and sourcePlayer can be nil - iMessageType is one of
 * OVERHEAD_ALERT_*.
 */
declare function SendOverheadEventMessage(
    this: void,
    sendToPlayer: CDOTAPlayer,
    messageType: number,
    targetEntity: CDOTA_BaseNPC,
    value: number,
    sourcePlayer: CDOTAPlayer,
): void;
 ...
 * @both
 */
declare function SendToConsole(this: void, arg1: string): void;

/**
 * Send a string to the console as a server command.
 */
declare function SendToServerConsole(this: void, arg1: string): void;
 ...
 * @both
 */
declare function SetOpvarFloatAll(this: void, arg1: string, arg2: string, arg3: string, arg4: number): void;
 ...
 * @both
 */
declare function SetOpvarFloatPlayer(
    this: void,
    arg1: string,
    arg2: string,
    arg3: string,
 ...
 * @both
 */
declare function SetPhysAngularVelocity(this: void, arg1: object, arg2: Vector): void;
 ...
 * @both
 */
declare function SetQuestName(this: void, arg1: string): void;
 ...
 * @both
 */
declare function SetQuestPhase(this: void, arg1: number): void;
 ...
 * @both
 */
declare function SetRenderingEnabled(this: void, arg1: number, arg2: boolean): void;

declare function SetTeamCustomHealthbarColor(this: void, team: DOTATeam_t, r: number, g: number, b: number): void;

/**
 * Supports localized strings - %s1 = PlayerName, %s2 = Value, %s3 = TeamName.
 */
declare function ShowCustomHeaderMessage(
    this: void,
    message: string,
    playerId: PlayerID,
    value: number,
 ...
 */
declare function ShowGenericPopup(
    this: void,
    arg1: string,
    arg2: string,
    arg3: string,
 ...
 */
declare function ShowMessage(this: void, arg1: string): void;

declare function SpawnDOTAShopTriggerRadiusApproximate(this: void, origin: Vector, radius: number): CDOTA_ShopTrigger;
 ...
 * @both
 */
declare function SpawnEntityFromTableSynchronous(this: void, baseclass: string, data: object): CBaseEntity;
 ...
 * @both
 */
declare function SpawnEntityGroupFromTable(this: void, arg1: object, arg2: boolean, arg3: object): boolean;
 ...
 * @both
 */
declare function SpawnEntityListFromTableAsynchronous(this: void, arg1: object, arg2: object): number;
 ...
 * @both
 */
declare function SpawnEntityListFromTableSynchronous(this: void, arg1: object): object;
 ...
 * @both
 */
declare function SplineQuaternions(this: void, arg1: Quaternion, arg2: Quaternion, arg3: number): Quaternion;
 ...
 * @both
 */
declare function SplineVectors(this: void, arg1: Vector, arg2: Vector, arg3: number): Vector;
 ...
 * @both
 */
declare function StartSoundEvent(this: void, arg1: string, arg2: object): void;
 ...
 * @both
 */
declare function StartSoundEventFromPosition(this: void, soundName: string, position: Vector): void;
 ...
 * @both
 */
declare function StartSoundEventFromPositionReliable(this: void, soundName: string, position: Vector): void;
 ...
 * @both
 */
declare function StartSoundEventFromPositionUnreliable(this: void, soundName: string, position: Vector): void;
 ...
 * @both
 */
declare function StartSoundEventReliable(this: void, arg1: string, arg2: object): void;
 ...
 * @both
 */
declare function StartSoundEventUnreliable(this: void, arg1: string, arg2: object): void;
 ...
 * @both
 */
declare function StopEffect(this: void, arg1: object, arg2: string): void;

/**
 * Stop named sound for all players.
 */
declare function StopGlobalSound(this: void, arg1: string): void;
 ...
 * @both
 */
declare function StopListeningToAllGameEvents(this: void, arg1: object): void;
 ...
 * @both
 */
declare function StopListeningToGameEvent(this: void, listenerId: EventListenerID): boolean;
 ...
 * @both
 */
declare function StopSoundEvent(this: void, arg1: string, arg2: object): void;
 ...
 * @both
 */
declare function StopSoundOn(this: void, arg1: string, arg2: object): void;
 ...
 * @both
 */
declare function TraceCollideable(this: void, arg1: object): boolean;
 ...
 * @both
 */
declare function TraceHull(this: void, arg1: object): boolean;
 ...
 * @both
 */
declare function TraceLine(this: void, arg1: object): boolean;
 ...
 * @both
 */
declare function UnloadSpawnGroup(this: void, arg1: string): void;
 ...
 * @both
 */
declare function UnloadSpawnGroupByHandle(this: void, arg1: number): void;

declare function UpdateEventPoints(this: void, eventPointData: object): void;

/**
 * Returns the number of degrees difference between two yaw angles.
 */
declare function UTIL_AngleDiff(this: void, arg1: number, arg2: number): number;
 ...
 */
declare function UTIL_MessageTextAll(
    this: void,
    arg1: string,
    arg2: number,
    arg3: number,
 ...
 * @both
 */
declare function UTIL_Remove(this: void, entity: CBaseEntity): void;
 ...
 * @both
 */
declare function UTIL_RemoveImmediate(this: void, entity: CBaseEntity): void;

/**
 * Clear all message text on one client.
 */
declare function UTIL_ResetMessageText(this: void, arg1: number): void;

/**
 * Clear all message text from all clients.
 */
declare function UTIL_ResetMessageTextAll(this: void): void;

declare function VectorAngles(this: void, arg1: Vector): QAngle;
 ...
 * @both
 */
declare function VectorToAngles(this: void, arg1: Vector): QAngle;
 ...
 * @both
 */
declare function Warning(this: void, message: string): void;
