...
declare const enum AttributeDerivedStats {
    ...
    STRENGTH_HP = 1,
    STRENGTH_HP_REGEN = 2,
    STRENGTH_STATUS_RESISTANCE_PERCENT = 3,
    STRENGTH_MAGIC_RESISTANCE_PERCENT = 4,
    AGILITY_DAMAGE = 5,
    AGILITY_ARMOR = 6,
    AGILITY_ATTACK_SPEED = 7,
    AGILITY_MOVE_SPEED_PERCENT = 8,
    INTELLIGENCE_DAMAGE = 9,
    INTELLIGENCE_MANA = 10,
    INTELLIGENCE_MANA_REGEN = 11,
    INTELLIGENCE_SPELL_AMP_PERCENT = 12,
    INTELLIGENCE_MAGIC_RESISTANCE_PERCENT = 13,
}
...
declare const DOTA_PLAYER_LOADOUT_END: 76;

declare const DOTA_LOADOUT_TYPE_COUNT: 78;
...
declare const enum GameActivity {
    ...
    DOTA_SHUFFLE_L = 1749,
    DOTA_SHUFFLE_R = 1750,
    DOTA_ARCANA_VOTE = 1751,
    DOTA_SPIRIT_BREAKER_ULT_RUN = 1752,
    DOTA_PUNCH = 1753,
    DOTA_CAST_STATUE = 1754,
    DOTA_ATTACK_STATUE = 1755,
    DOTA_CAST_3_STATUE = 1756,
    DOTA_CAST_1_STATUE = 1757,
    DOTA_TELEPORT_STATUE = 1758,
    DOTA_VICTORY_STATUE = 1759,
    DOTA_TAUNT_STATUE = 1760,
    DOTA_STATUE_SEQUENCE = 1761,
    DOTA_STORM_ABILITY_4 = 1763,
    DOTA_RUN_STATUE = 1764,
    DOTA_IDLE_STATUE = 1765,
    DOTA_CAST_4_STATUE = 1766,
    DOTA_STUN_STATUE = 1767,
    DOTA_FLAIL_STATUE = 1768,
    DOTA_CAST_2_STATUE = 1769,
    DOTA_DISABLED_END = 1770,
    DOTA_RELAX_IN = 1771,
    DOTA_RELAX_OUT = 1772,
    DOTA_CAST_FENCE = 1773,
    DOTA_SPWN = 1774,
...
declare const enum ItemTransient {
    ITEM = 17,
    RECIPE = 18,
    CAST_ITEM = 20,
}
...
declare const MODIFIER_FUNCTION_LAST: 223;
...
declare const enum ModifierFunction {
     ...
     */
    MP_RESTORE_AMPLIFY_PERCENTAGE = 46,
    /**
     * Method Name: `GetModifierBaseDamageOutgoing_Percentage`
     */
    BASEDAMAGEOUTGOING_PERCENTAGE = 47,
    /**
     * Not working.
     *
     *
     ...
     */
    BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 48,
    /**
     * Method Name: `GetModifierIncomingDamage_Percentage`
     */
    INCOMING_DAMAGE_PERCENTAGE = 49,
    /**
     * Method Name: `GetModifierIncomingPhysicalDamage_Percentage`
     */
    INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 50,
    /**
     * Not working.
     *
     *
     ...
     */
    INCOMING_PHYSICAL_DAMAGE_CONSTANT = 51,
    /**
     * Method Name: `GetModifierIncomingSpellDamageConstant`
     */
    INCOMING_SPELL_DAMAGE_CONSTANT = 52,
    /**
     ...
     */
    IGNORE_PHYSICAL_ARMOR = 66,
    /**
     * Method Name: `GetModifierMagicalResistanceBaseReduction`
     */
    MAGICAL_RESISTANCE_BASE_REDUCTION = 67,
    /**
     * Not working.
     *
     *
     ...
     */
    HEALTH_REGEN_PERCENTAGE_UNIQUE = 78,
    /**
     ...
     */
    EXTRA_STRENGTH_BONUS = 81,
    /**
     * Method Name: `GetModifierExtraHealthBonus`
     */
    EXTRA_HEALTH_BONUS = 82,
    /**
     ...
     */
    CAST_RANGE_BONUS_TARGET = 93,
    /**
     * Method Name: `GetModifierCastRangeBonusStacking`
     */
    CAST_RANGE_BONUS_STACKING = 94,
    /**
     * Not working.
     *
     *
     ...
     */
    ATTACK_RANGE_BASE_OVERRIDE = 95,
    /**
     * Method Name: `GetModifierAttackRangeBonus`
     */
    ATTACK_RANGE_BONUS = 96,
    /**
     * Not working.
     *
     *
     ...
     */
    ATTACK_RANGE_BONUS_UNIQUE = 97,
    /**
     * Method Name: `GetModifierAttackRangeBonusPercentage`
     */
    ATTACK_RANGE_BONUS_PERCENTAGE = 98,
    /**
     * Not working.
     *
     *
     ...
     */
    PROJECTILE_SPEED_BONUS = 100,
    /**
     * Method Name: `GetModifierProjectileSpeedBonusPercentage`
     */
    PROJECTILE_SPEED_BONUS_PERCENTAGE = 101,
    /**
     ...
     */
    MANACOST_PERCENTAGE_STACKING = 111,
    /**
     ...
     */
    PREATTACK_TARGET_CRITICALSTRIKE = 115,
    /**
     * Not working.
     *
     *
     ...
     */
    MAGICAL_CONSTANT_BLOCK = 116,
    /**
     * Method Name: `GetModifierPhysical_ConstantBlock`
     */
    PHYSICAL_CONSTANT_BLOCK = 117,
    /**
     * Not working.
     *
     *
     ...
     */
    DISABLE_AUTOATTACK = 126,
    /**
     * Method Name: `GetBonusDayVision`
     */
    BONUS_DAY_VISION = 127,
    /**
     * Method Name: `GetBonusNightVision`
     */
    BONUS_NIGHT_VISION = 128,
    /**
     * Not working.
     *
     *
     ...
     */
    BONUS_NIGHT_VISION_UNIQUE = 129,
    /**
     * Method Name: `GetBonusVisionPercentage`
     */
    BONUS_VISION_PERCENTAGE = 130,
    /**
     * Method Name: `GetFixedDayVision`
     */
    FIXED_DAY_VISION = 131,
    /**
     * Method Name: `GetFixedNightVision`
     */
    FIXED_NIGHT_VISION = 132,
    /**
     ...
     */
    ABSOLUTE_NO_DAMAGE_PHYSICAL = 134,
    /**
     * Method Name: `GetAbsoluteNoDamageMagical`
     */
    ABSOLUTE_NO_DAMAGE_MAGICAL = 135,
    /**
     * Method Name: `GetAbsoluteNoDamagePure`
     */
    ABSOLUTE_NO_DAMAGE_PURE = 136,
    /**
     ...
     */
    ALWAYS_ALLOW_ATTACK = 145,
    /**
     * Method Name: `GetAllowEtherealAttack`
     */
    ALWAYS_ETHEREAL_ATTACK = 146,
    /**
     * Method Name: `GetOverrideAttackMagical`
     */
    OVERRIDE_ATTACK_MAGICAL = 147,
    /**
     * Not working.
     *
     *
     ...
     */
    UNIT_STATS_NEEDS_REFRESH = 148,
    /**
     * Unused
     */
    BOUNTY_CREEP_MULTIPLIER = 149,
    /**
     * Unused
     */
    BOUNTY_OTHER_MULTIPLIER = 150,
    /**
     * Method Name: `GetModifierUnitDisllowUpgrading`
     */
    UNIT_DISALLOW_UPGRADING = 151,
    /**
     * Not working.
     *
     *
     ...
     */
    DODGE_PROJECTILE = 152,
    /**
     * Method Name: `GetTriggerCosmeticAndEndAttack`
     */
    TRIGGER_COSMETIC_AND_END_ATTACK = 153,
    /**
     * Not working.
     *
     *
     ...
     */
    ON_SPELL_TARGET_READY = 154,
    /**
     * Method Name: `OnAttackRecord`
     */
    ON_ATTACK_RECORD = 155,
    /**
     ...
     */
    ON_ATTACK_ALLIED = 160,
    /**
     * Method Name: `OnProjectileDodge`
     */
    ON_PROJECTILE_DODGE = 161,
    /**
     * Method Name: `OnOrder`
     */
    ON_ORDER = 162,
     ...
     */
    ON_ABILITY_START = 164,
    /**
     * Method Name: `OnAbilityExecuted`
     */
    ON_ABILITY_EXECUTED = 165,
    /**
     * Method Name: `OnAbilityFullyCast`
     */
    ON_ABILITY_FULLY_CAST = 166,
    /**
     * Not working.
     *
     *
     ...
     */
    ON_BREAK_INVISIBILITY = 167,
    /**
     * Method Name: `OnAbilityEndChannel`
     */
    ON_ABILITY_END_CHANNEL = 168,
    /**
     * Unused
     */
    ON_PROCESS_UPGRADE = 169,
    /**
     * Unused
     */
    ON_REFRESH = 170,
     ...
     */
    ON_DEATH_PREVENTED = 172,
    /**
     * Method Name: `OnStateChanged`
     */
    ON_STATE_CHANGED = 173,
    /**
     * Unused
     */
    ON_ORB_EFFECT = 174,
     ...
     */
    ON_PROCESS_CLEAVE = 175,
    /**
     * Method Name: `OnDamageCalculated`
     */
    ON_DAMAGE_CALCULATED = 176,
    /**
     ...
     */
    ON_HEAL_RECEIVED = 188,
    /**
     * Method Name: `OnBuildingKilled`
     */
    ON_BUILDING_KILLED = 189,
    /**
     * Method Name: `OnModelChanged`
     */
    ON_MODEL_CHANGED = 190,
    /**
     * Not working.
     *
     *
     ...
     */
    IGNORE_CAST_ANGLE = 204,
    /**
     * Method Name: `GetModifierChangeAbilityValue`
     */
    CHANGE_ABILITY_VALUE = 205,
    /**
     ...
     */
    PRESERVE_PARTICLES_ON_MODEL_CHANGE = 209,
    /**
     * Method Name: `OnAttackFinished`
     */
    ON_ATTACK_FINISHED = 210,
    /**
     * Not working.
     *
     *
     ...
     */
    CAN_ATTACK_TREES = 212,
    /**
     * Method Name: `GetVisualZDelta`
     */
    VISUAL_Z_DELTA = 213,
    INCOMING_DAMAGE_ILLUSION = 214,
    /**
     * Method Name: `GetModifierNoVisionOfAttacker`
     */
    DONT_GIVE_VISION_OF_ATTACKER = 215,
    /**
     ...
     */
    ON_ATTACK_RECORD_DESTROY = 217,
    /**
     * Method Name: `OnProjectileObstructionHit`
     */
    ON_PROJECTILE_OBSTRUCTION_HIT = 218,
    /**
     * Method Name: `GetSuppressTeleport`
     */
    SUPPRESS_TELEPORT = 219,
    /**
     * Method Name: `OnAttackCancelled`
     */
    ON_ATTACK_CANCELLED = 220,
    /**
...
declare const MODIFIER_STATE_LAST: 43;
...
declare const MAX_PATTACH_TYPES: 15;
...
declare const enum SourceEngineAnimationEvent {
    ...
    CL_DOTA_PLAY_STATUS_EFFECT = 192,
    CL_DOTA_STOP_STATUS_EFFECT = 193,
    CL_DOTA_NPC_CREATE_PARTICLE_EFFECT = 194,
    CL_DOTA_RUBICK_ARCANA_CREATE_PARTICLE_EFFECT = 195,
    DOTA_SUPPRESS_CONSTANT_LAYER = 196,
    DOTA_PLAY_SOUND_ATTACK_SPECIAL = 197,
}
