...
DOTA_ABILITY_BEHAVIOR_DONT_CANCEL_CHANNEL = 536870912 -- 不取消持续施法 （note: 会调用OnChannelFinish 然后继续OnChannelThink）
...
DOTA_ABILITY_BEHAVIOR_IGNORE_CHANNEL = 4194304 -- 忽略持续施法 （不打断当前的持续施法）
DOTA_ABILITY_BEHAVIOR_IGNORE_PSEUDO_QUEUE = 2097152
DOTA_ABILITY_BEHAVIOR_IMMEDIATE = 2048 -- 立即释放
